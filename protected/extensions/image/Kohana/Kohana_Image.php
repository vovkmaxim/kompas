...
Yii::import('application.extensions.image.Image.Image_GD');
Yii::import('application.extensions.image.Image.Image_Imagick');
...
abstract class Kohana_Image
{
    ...
    public static function factory($file, $driver = NULL)
    {
        ...
        } elseif (is_array($driver) && isset($driver['driver'])) {
    ...
    public function __construct($file)
    {
        ...
        if (empty($file) OR empty($info)) {
            throw new CException('Not an image or invalid image: :file' . $file);
        }
    ...
    public function save($file = NULL, $quality = 100)
    {
        ...
        if (is_file($file)) {
            if (!is_writable($file)) {
                throw new CException('File must be writable: :file' . $file);
            }
        } else {
