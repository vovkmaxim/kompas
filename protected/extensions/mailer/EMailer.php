...
class EMailer
{
    ...
    public function __construct()
    {
        $this->_myMailer = new PHPMailer();
         $this->_myMailer->Host = 'mail.ukraine.com.ua';
         $this->_myMailer->Port = 25;
         $this->_myMailer->Helo = '';
         $this->_myMailer->SMTPSecure = '';
         $this->_myMailer->SMTPAuth = true;
         $this->_myMailer->Username = '300watches@chisw.us';
         $this->_myMailer->Password = '4vz1VD2y';
    }
