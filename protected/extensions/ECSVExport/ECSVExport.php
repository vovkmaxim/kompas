...
class ECSVExport
{
     ...
     */
    public $convertActiveDataProvider = false;
     ...
     */
    public function toCSV($outputFile=null, $delimiter=null, $enclosure=null, $includeHeaders=true, $relations = null)
    {
     ...
     */
    protected function _writeData($relations)
    {        
